...
/** Manus Home Switch Guide — catalog taxonomy unchanged (no PCB). */
        ...
        <div className="order-1 lg:order-2">
          ...
          <div className="mt-6 space-y-3">
            {SWITCH_TYPES.map((sw) => (
              <div
                key={sw.type}
                className="flex items-center gap-4 border border-border border-l-4 border-l-primary bg-white p-4 dark:bg-ca-surface-container"
              >
